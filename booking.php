...
<!-- Error radio button set default value -->        
        <h5>Choose your car type:</h5>
            <input type="radio" name="radio" value="ac" ng-model="myVar" ng-init="myVar='ac'"> <b>With AC</b>
            <input type="radio" name="radio" value="non_ac" ng-model="myVar"> <b>Without AC</b>
